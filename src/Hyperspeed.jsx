...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  useEffect(() => {
    ...
    class App {
      ...
      initPasses() {
        // Bloom only — SMAA requests depth and triggers GL_INVALID_OPERATION
        // (blitDepthBuffer) every frame with EffectComposer.
      ...
      update(delta) {
        ...
        const time = (this.clock.elapsedTime + this.timeOffset) * this.timeScale;
    ...
    // Init synchronously — no SMAA image preload needed.
    // Guard against StrictMode unmount racing an async init.
